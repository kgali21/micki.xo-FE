    ...
    <section id='About' className={styles.AboutContainer} >
      <div className={styles.AboutList}>
        <div className={styles.AboutText}>
          ...
          <p className={styles.AboutBio}>2020 was a tumultuous year for everyone, but it was also a turning point for Micki XO, which led her to share her first story with the world through her debut single "Why Did I Stay?" What's next for this up-and-coming, pop artist? Follow along to find out!</p>
          <Subscribe />
        </div>
      </div>
    </section>
